...
resource "octopusdeploy_tenant_project" "europe_project_environment" {
  environment_ids = [
...
resource "octopusdeploy_tenant_project" "europe_project_cac_environment" {
  environment_ids = [
    data.octopusdeploy_environments.development.environments[0].id,
    data.octopusdeploy_environments.test.environments[0].id,
    data.octopusdeploy_environments.production.environments[0].id,
...
resource "octopusdeploy_tenant_project" "europe_project_web_app_cac_environment" {
  environment_ids = [
    data.octopusdeploy_environments.development.environments[0].id,
    data.octopusdeploy_environments.test.environments[0].id,
    data.octopusdeploy_environments.production.environments[0].id,
...
resource "octopusdeploy_tenant_project" "europe_project_init_space_environment" {
  environment_ids = [
    data.octopusdeploy_environments.sync.environments[0].id
  ]
...
resource "octopusdeploy_tenant_project" "europe_project_create_client_space_environment" {
  environment_ids = [
    data.octopusdeploy_environments.sync.environments[0].id
  ]
...
resource "octopusdeploy_tenant_project" "europe_project_k8s_microservice_template_space_environment" {
  environment_ids = [
    data.octopusdeploy_environments.sync.environments[0].id
  ]
...
resource "octopusdeploy_tenant_project" "europe_project_init_space_k8s_environment" {
  environment_ids = [
    data.octopusdeploy_environments.sync.environments[0].id
  ]
...
resource "octopusdeploy_tenant_common_variable" "europe_octopus_apikey" {
  ...
  depends_on = [
    octopusdeploy_tenant_project.europe_project_environment,
    octopusdeploy_tenant_project.europe_project_cac_environment,
    octopusdeploy_tenant_project.europe_project_web_app_cac_environment,
    octopusdeploy_tenant_project.europe_project_init_space_environment,
    octopusdeploy_tenant_project.europe_project_create_client_space_environment,
    octopusdeploy_tenant_project.europe_project_k8s_microservice_template_space_environment,
    octopusdeploy_tenant_project.europe_project_init_space_k8s_environment,
  ]
}
